...
function formatJobDateRange(startDate: string, endDate: string): string {
...
function JobExternalLinks({ githubUrl, projectUrl }: { githubUrl?: string; projectUrl?: string }) {
  const gh = githubUrl?.trim();
  const pr = projectUrl?.trim();
  if (!gh && !pr) return null;

  return (
    <div className="card-job-links">
      {gh ? (
        <a
          href={gh}
          className="card-job-link card-job-link--github"
          target="_blank"
          rel="noopener noreferrer"
      ...
      {pr ? (
        <a
          href={pr}
          className="card-job-link card-job-link--project"
          target="_blank"
          rel="noopener noreferrer"
          title="Open project link (demo, article, or artifact)"
        >
          {openArtifactIcon}
      ...
      >
        ...
        >
          <div className="card-header-row">
            ...
            >
              {formatJobDateRange(data.StartDate, data.EndDate)}
            </p>
          </div>
          <JobExternalLinks githubUrl={data.githubUrl} projectUrl={data.projectUrl} />
        </div>
